...
<div class="mx-auto max-w-3xl p-6">
    ...
    <div class="mt-4 space-y-3">
        ...
        @php
            $faqs = [
                ['q' => '一条视频怎么从零做出来？', 'a' => '三步：①智能选题（或直接粘贴你的文案）→ ②智能二创润色 → ③视频出片选形式生成。平台支持 6 种形式：幕后音·动态画面（男声/女声/对话）、数字人出镜、滚动字幕卡、AI 漫剧、AI 白板图解。生成后在视频库可质检、审核、发布。'],
                ['q' => '各种出片形式有什么区别？', 'a' => '幕后音·动态画面：不露脸，配音 + 动态画面 + 卡拉OK字幕，出片快（1-3 分钟）；数字人出镜：用你自己的出镜形象驱动数字人说话，更有真人感（5-10 分钟）；滚动字幕卡：配音 + 中部滚动字幕；AI 漫剧：内容自动转剧情/讲解分镜漫画（可选 AI 动效，约 6 元/条）；AI 白板图解：内容提炼成手绘白板逐笔画出（零 API 费用）。法条/政策类内容漫剧会自动改走口播以保精确。'],
                ...
                ['q' => '每月能生成多少条视频？', 'a' => '看套餐：免费试用 10 条/月，专业版 200 条/月，企业版不限量（具体以管理员配置为准）。用量与剩余额度在出片页顶部实时显示。'],
                ['q' => '试用期有什么限制？', 'a' => '试用期内单条视频 ≤10 分钟；累计生成条数/时长按租户配置执行，到期或超限会提示升级。具体限额以管理员设置为准。'],
