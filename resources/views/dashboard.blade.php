...
<div class="p-6">
    ...
    <section class="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="mb-4 flex items-center gap-2">
            ...
            <span class="rounded-full bg-brand-50 px-2.5 py-0.5 text-xs font-medium text-brand-600">粘贴文案 → 选形式 → 出片</span>
        </div>
        ...
        <div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4" id="quick-forms">
            <button type="button" data-form="scroll" data-target="/studio/rewrite" class="quick-form active">
                <span class="q-ico">🎬</span>滚动字幕卡
            </button>
            <button type="button" data-form="avatar" data-target="/studio/rewrite" class="quick-form">
                <span class="q-ico">🤖</span>数字人出镜
            </button>
            <button type="button" data-form="motion" data-target="/studio/rewrite" class="quick-form">
                <span class="q-ico">✨</span>幕后音·动态画面
            </button>
            <button type="button" data-form="xhs" data-target="/studio/xhs" class="quick-form">
                <span class="q-ico">📕</span>小红书图文
            </button>
        </div>

        <button id="quick-go" class="mt-4 w-full rounded-xl bg-brand-600 py-3.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-700">
            🚀 一键生成
        </button>
    ...
    <style>
        .quick-form { display:flex; flex-direction:column; align-items:center; gap:4px; border:1px solid #e2e8f0; border-radius:14px; padding:14px 8px; font-size:13.5px; color:#475569; background:#fff; transition:all .15s; }
        .quick-form:hover { border-color:#c7d2fe; background:#f8fafc; transform:translateY(-1px); }
        ...
        .quick-form .q-ico { font-size:26px; line-height:1.2; }
    </style>
